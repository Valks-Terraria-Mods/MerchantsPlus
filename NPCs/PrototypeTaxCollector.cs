...
namespace MerchantsPlus.NPCs
{
    class PrototypeTaxCollector : ModNPC
    {
        ...
        {
            return Utils.dialog(new string[] { "Heh heh heh (all your gold was removed from your inventory) (jk)" });
        }
